...
with DAG(
    ...
    def python_push_xcom():
        ...
        return result_dict # xcom에 return_value에 담김 
    ...
    bash_pull = BashOperator(
        ...
        env={
            ...
            'OPTIONS_CNT':'{{ti.xcom_pull(task_ids="python_push")["options_cnt"]}}' # xcom에 STATUS, DATA, OPTIONS_CNT

        },
        bash_command='echo $STATUS && echo $DATA && echo $OPTIONS_CNT' # xcom return_value = $OPTIONS_CNT값이 담김
    )
